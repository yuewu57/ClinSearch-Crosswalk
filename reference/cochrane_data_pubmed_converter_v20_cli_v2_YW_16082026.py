...
def validate_protected_hyphenated_terms(original: str, converted: str) -> list[str]:
    """
    ...
    for match in PROTECTED_HYPHENATED_TERM_RE.finditer(normalized_original):
        ...
        if comparison_term and comparison_term not in normalized_converted:
...
def convert_file(
    ...
    try:
        ...
        for original_num, expr in rows:
            ...
            protected_term_errors = validate_protected_hyphenated_terms(expr, converted)
