...
app.innerHTML = `
<header class="site-header"><a class="brand" href="./" aria-label="ClinSearch-Crosswalk home"><span class="brand-mark" aria-hidden="true">⇄</span><span>ClinSearch<span class="brand-light">–Crosswalk</span></span></a><div class="header-meta"><span class="local-dot" aria-hidden="true"></span>Runs on your device<span class="preview-badge">DEVELOPMENT PREVIEW</span></div></header>
